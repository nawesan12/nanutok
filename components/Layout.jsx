        ...
        <>
            ...
            <nav className="navigation">
                ...
                <div className={window.location.pathname === '/create' ? 'link active' : 'link'}>
                    <Link href="/create"><a>
                        <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-square-plus create" width="42" height="36" viewBox="0 0 24 24" strokeWidth="1.5" stroke="#ffffff" fill="none" strokeLinecap="round" strokeLinejoin="round">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
